...
?>
<body id="body">
  <h1 class="text-center my-3">Staff Creation Form</h1>
  <div class="container d-flex justify-content-center">
    <form id="create_staff" action="" method="post">
      <div class="row">
        <div class="col">
      ...
      <div class="row">
        <div class="col">
          ...
          <input type="text" name="dateofbirth" id="dateofbirth" class="form-control" placeholder="Date Of Birth" required onfocus="(this.type='date')" onblur="(this.type='text')">
        </div>
        <div class="col">
          <!--<label for="phoneno">Phone No:</label>-->
          <input type="tel" name="phoneno" id="phoneno" class="form-control" pattern="[0-9]{10}" placeholder="Phone No:" required>
        </div>
        <div class="row">
          <div class="col">
          ...
          <div class="col">
            ...
            <select name="bloodgroup" id="bloodgroup" class="form-control" placeholder="Blood Group" required>
        ...
        <div class="row">
          <div class="col">
            ...
            <input type="text" name="addressline1" id="addressline1" class="form-control" placeholder="Address Line 1" required>
          </div>
          <div class="col">
        ...
        <div class="row">
          <div class="col">
            ...
            <input type="text" name="country" id="countryselect" class="form-control" placeholder="Choose a Country" required>
          </div>
          <div class="col">
            <!--<label for="pincode">Pincode</label>-->
            <input type="text" name="pincode" id="pincode" class="form-control" placeholder="Pincode / Zipcode" required>
          </div>
          <div class="col">
        ...
        <div class="row">
          ...
          <div class="col">
            ...
            <option value="" selected disabled hidden>Select a Staff Role</option>
