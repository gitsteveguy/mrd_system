(function() {
	var canvas = document.getElementById('sign2');
	var ctx = canvas.getContext('2d');
	var body = document.getElementById('body');
	var canvasdiv = document.getElementById('signdiv2');
	var canvasdiv_style = getComputedStyle(canvasdiv);
    var clearbtnsign = document.getElementById('clearsignbtn2');
    var csign = document.getElementById('signconfirm2');
    var signuri = document.getElementById('signimageuri2');
